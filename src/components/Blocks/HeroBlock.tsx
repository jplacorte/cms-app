...
export default function HeroBlock({
  ...
  const isDark = bgColor.toLowerCase() === "#000000" || bgColor.startsWith("#0") || bgColor.startsWith("#1");
  ...
  return (
    ...
    >
      ...
      <div className={`max-w-7xl mx-auto px-6 py-24 md:py-32 relative z-10 flex ${layout === "split" ? "flex-col lg:flex-row items-center gap-16" : "flex-col items-center text-center"}`}>
        
        <div className={`flex flex-col ${getAlignClass()} ${layout === "split" ? "lg:w-1/2" : "w-full max-w-4xl"}`}>
          ...
          <div className="lg:w-1/2 w-full relative">
            {imageUrl ? (
              ...
              <div 
                ...
                style={{ 
                  background: isDark ? "linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.01) 100%)" : "linear-gradient(135deg, rgba(0,0,0,0.03) 0%, rgba(0,0,0,0.01) 100%)",
              ...
              >
                ...
                <div className="text-sm font-mono p-4 rounded bg-black/40 text-white/70 border border-white/10 z-10 shadow-xl">
                  Upload Image in Properties Panel
                  <br/>
                  <span className="text-blue-400">const</span> hero = <span className="text-green-400">&quot;Awesome&quot;</span>;
                </div>
              </div>
            )}
          </div>
